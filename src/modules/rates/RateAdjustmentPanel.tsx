...
const IconInfo: React.FC<{ className?: string; style?: React.CSSProperties }> = ({ className, style }) => (
  <svg className={className} style={style} width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10.5 5.1001C10.5 4.70227 10.658 4.32074 10.9393 4.03944C11.2206 3.75813 11.6022 3.6001 12 3.6001C12.3978 3.6001 12.7794 3.75813 13.0607 4.03944C13.342 4.32074 13.5 4.70227 13.5 5.1001C13.5 5.49792 13.342 5.87945 13.0607 6.16076C12.7794 6.44206 12.3978 6.6001 12 6.6001C11.6022 6.6001 11.2206 6.44206 10.9393 6.16076C10.658 5.87945 10.5 5.49792 10.5 5.1001ZM9 9.9001C9 9.40135 9.40125 9.0001 9.9 9.0001H12C12.4988 9.0001 12.9 9.40135 12.9 9.9001V19.8001H14.7C15.1988 19.8001 15.6 20.2013 15.6 20.7001C15.6 21.1988 15.1988 21.6001 14.7 21.6001H9.3C8.80125 21.6001 8.4 21.1988 8.4 20.7001C8.4 20.2013 8.80125 19.8001 9.3 19.8001H11.1V10.8001H9.9C9.40125 10.8001 9 10.3988 9 9.9001Z" fill="currentColor"/>
  </svg>
);
